...
!(function(e, t, n, o, r) {
  ...
  function Cn(e, t) {
    e = i(e) ? e[0] : e;
    for (
      var n = null != t ? bn(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        r = 0;
      r < n.length;
      r++
  ...
  return (
    ...
    function(e, E) {
      ...
      if (!yn(u, Wt)) {
        ...
        Ot(),
          (Rt.fp_easings = wn(Rt.fp_easings, {
          ...
          d &&
            ...
            (h.destroy = function(e) {
              J(!1, "internal"),
                ...
                ie(!1),
                In(d, Vt),
                [y, w, S, k, O, C, b].forEach(function(e) {
                  clearTimeout(e);
                }),
            ...
            (h.test = {
              ...
              translate3dH: (function() {
                for (
                  var e = [], t = 0;
                  t < bn(E.sectionSelector, d).length;
                  t++
                )
            ...
            (function() {
              xn(d, { height: "100%", position: "relative" }),
                ...
                (A = En()),
                Rn(d, Vt),
                In(bn(E.sectionSelector, d), Kt),
                In(bn(E.slideSelector, d), nn);
              for (var e = bn(_t), t = 0; t < e.length; t++) {
                ...
                o.setAttribute("data-fp-styles", o.getAttribute("style")),
                  ...
                  E.menu &&
                    E.css3 &&
                    null != Dn(bn(E.menu)[0], jt) &&
                    bn(E.menu).forEach(function(e) {
                      L.appendChild(e);
                    }),
              ...
              E.fixedElements &&
                E.css3 &&
                bn(E.fixedElements).forEach(function(e) {
                  L.appendChild(e);
                }),
                E.navigation &&
                  (function() {
                    ...
                    var n = bn(en)[0];
                    In(n, "fp-" + E.navigationPosition),
                      E.showActiveTooltip && In(n, "fp-show-active");
        ...
        e
          ? (ne(!0),
            (function() {
              if (o || l) {
                E.autoScrolling &&
                  (L.removeEventListener(H.touchmove, Ae, { passive: !1 }),
                  L.addEventListener(H.touchmove, Ae, { passive: !1 }));
                var e = E.touchWrapper;
                e.removeEventListener(H.touchstart, Oe),
                  e.removeEventListener(H.touchmove, Te, { passive: !1 }),
                  e.addEventListener(H.touchstart, Oe),
                  e.addEventListener(H.touchmove, Te, { passive: !1 });
              }
            })())
          : (ne(!1),
            (function() {
              if (o || l) {
                E.autoScrolling &&
                  (L.removeEventListener(H.touchmove, Te, { passive: !1 }),
                  L.removeEventListener(H.touchmove, Ae, { passive: !1 }));
                var e = E.touchWrapper;
                e.removeEventListener(H.touchstart, Oe),
                  e.removeEventListener(H.touchmove, Te, { passive: !1 });
      ...
      function le() {
        var e = An(bn($t)[0], _t);
        e || (!E.loopTop && !E.continuousVertical) || (e = Mn(bn(_t))),
          null != e && Ie(e, null, !0);
      }
      function ae() {
        var e = Tn(bn($t)[0], _t);
        e || (!E.loopBottom && !E.continuousVertical) || (e = bn(_t)[0]),
          null != e && Ie(e, null, !1);
      }
      function se(e, t) {
        ...
        if (!yn(d, Vt)) {
          ...
          for (var t = bn(_t), n = 0; n < t.length; ++n) {
            var o = t[n],
              r = bn(an, o)[0],
              i = bn(on, o);
            E.verticalCentered && xn(bn(Qt, o), { height: vt(o) + "px" }),
              xn(o, { height: A + "px" }),
          ...
          ? ("touchend" === t &&
            ...
            ("mouseenter" !== t || V) &&
              (E.normalScrollElements.split(",").forEach(function(e) {
                if (!r) {
                  var t = _n(o, e),
                    n = Dn(o, e);
                  (t || n) &&
                    (h.shared.isNormalScrollElement || re(!1),
              ...
              !r &&
                ...
                (re(!0), (h.shared.isNormalScrollElement = !1))))
          : re(!0);
      }
      function Se() {
        var e = En(),
      ...
      function be(e, t, n) {
        ...
        var c = bn(rn, e)[0];
        null != c &&
        (0 !== Cn(bn($t), _t) || (0 === Cn(bn($t), _t) && 0 !== Cn(c)))
          ? Lt(c, "internal")
          : In(t[0], Ft);
      }
      function we(e, t) {
      ...
      function Ee() {
        ...
        if (!E.autoScrolling || E.scrollBar) {
          ...
          if (
            ...
            (o = n + En()),
            ("up" != t ? n <= Yn() : o >= Yn() + En()) &&
              (yn(bn($t)[0], Xt) || (In(bn($t)[0], Xt), Rn(Fn(bn($t)[0]), Xt))),
            !yn((e = f[s]), Ft))
          ) {
            Y = !0;
            var v,
            ...
            w && ((p = w.getAttribute("data-anchor")), (v = Cn(w))),
              T &&
                (In(e, Ft),
                Rn(Fn(e), Ft),
      ...
      function Te(e) {
        ...
        if (ke(e)) {
          ...
          (K = n.y),
            (_ = n.x),
            bn(an, t).length && Math.abs(X - _) > Math.abs(U - K)
              ? !a &&
        ...
        if (null != e) {
          ...
          if (
            ...
            E.autoScrolling &&
              ...
              ((p = d).isMovementUp
                ? Wn(bn($t)[0], Gn(p.activeSection, _t))
                : Vn(bn($t)[0], Jn(p.activeSection, _t).reverse()),
              xt(bn($t)[0].offsetTop),
              He(),
      ...
      function Pe(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? Wn(bn(_t)[0], t.wrapAroundElements)
            : Vn(bn(_t)[bn(_t).length - 1], t.wrapAroundElements),
          xt(bn($t)[0].offsetTop),
          He()),
      ...
      function Ve() {
        var e =
          bn(".fp-auto-height")[0] ||
          (ve() && bn(".fp-auto-height-responsive")[0]);
        E.lazyLoading &&
          e &&
          bn(_t + ":not(" + Ut + ")").forEach(function(e) {
            var t, n, o;
      ...
      function rt(e) {
        ...
        (t = e.slidesNav),
          ...
          E.slidesNavigation &&
            null != t &&
            (Rn(bn(Ut, t), Ft), In(bn("a", bn("li", t)[n]), Ft)),
          e.localIsResizing ||
      ...
      function gt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            l =
              (null ==
                (i = bn(on + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
                ((o = void 0 !== o ? o : 0), (i = bn(on, r)[o])),
              i);
          wt(n) === x || yn(n, Ft)
            ? mt(l)
            : Ie(n, function() {
